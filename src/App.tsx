    ...
    <div className="bg-gray-100 dark:bg-gray-800 min-h-screen pt-20">
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-3 text-lg text-gray-500 dark:text-gray-300">For inquiries please email us at <a href="mailto:change@pili-pinas.com">change@pili-pinas.com</a></p>
        </div>
      </div>
    </div>
  );
